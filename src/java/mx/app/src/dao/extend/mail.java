...
public class mail {
    ...
    public String sendMailResetPassword(UsersModel dataUser){
        String result = null;
        String email = dataUser.getFl_mail();
        String userName = dataUser.getFl_user_name();
        ...
        try {
            ...
            t.close();
            result="Success";
            new UsersControl().resetKeyPasswordUser(userName);
            new UsersControl().resetPasswordUser(userName);
        } catch (DAOException ex) {
            System.out.print("Error DAOException: "+ ex);
        } catch (SQLException ex) {
            System.out.print("Error SQLException: "+ex);
